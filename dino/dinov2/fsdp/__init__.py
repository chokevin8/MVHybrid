...
# edited above with this pull request: https://github.com/facebookresearch/dinov2/pull/281/commits/388568683c799ec7df673de751697c32266a9469
...
class FSDPCheckpointer(Checkpointer):
    def save(self, name: str, **kwargs: Any) -> None:
        ...
        data = {}
        with FSDP.state_dict_type(self.model, StateDictType.LOCAL_STATE_DICT): # for one node, multi GPU DDP: FULL_STATE_DICT, for multinode, multigpu FSDP: LOCAL_STATE_DICT
